...
WHERE teacher_id IS NOT NULL) AS ALL
FROM public.group_name_student
inner join teacher t on t.id = group_name_student.teacher_id
...
/**
 * @swagger
 * /admin/getGroupsActive:
 *   get:
 *     summary: "Guruhlar ro'yxatini olish(Bog'langalarini)"
 *     tags: 
 *       - "Student guruhi"
 *     security:
 *       - bearerAuth: []
